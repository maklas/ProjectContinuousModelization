...
public class RungeKutta45 extends BaseMethod {
    ...
    protected void iterate(Argument xArg, double from, double to, double step, ObjectMap<String, Argument> environment, Array<Function> functions, Model model) {
        ...
        for (Function function : functions) {
            ...
            while (x < to){
                ...
                xArg.setArgumentValue(x + (3.0 * h) / 8.0);
                ...
                h = calculateNewStep(h, err, result4, result5,  step / 100.0, step * 100.0);
            }
        }
    }
    ...
    private static double calculateNewStep3(double oldStep, double err, double rk4, double rk5){
        double eMax = 0.5;
        double eMin = 0.05;
